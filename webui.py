    ...
    with gr.Row():
            ...
            with gr.Row(visible=False) as image_input_panel:
                with gr.Tabs():
                    with gr.TabItem(label='Upscale or Variation') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://mirror.ghproxy.com/https://github.com/lllyasviel/Fooocus/discussions/390" target="_blank">\U0001F4D4 Document</a>')
                    with gr.TabItem(label='Image Prompt') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by Fooocus Image Mixture Engine (v1.0.1). <a href="https://mirror.ghproxy.com/https://github.com/lllyasviel/Fooocus/discussions/557" target="_blank">\U0001F4D4 Document</a>')
                    ...
                    with gr.TabItem(label='Inpaint or Outpaint') as inpaint_tab:
                        ...
                        gr.HTML('* Powered by Fooocus Inpaint Engine <a href="https://mirror.ghproxy.com/https://github.com/lllyasviel/Fooocus/discussions/414" target="_blank">\U0001F4D4 Document</a>')
                    ...
                    with gr.TabItem(label='Describe') as desc_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://mirror.ghproxy.com/https://github.com/lllyasviel/Fooocus/discussions/1363" target="_blank">\U0001F4D4 Document</a>')
        ...
        with gr.Column(scale=1, visible=modules.config.default_advanced_checkbox) as advanced_column:
            with gr.Tab(label='Setting'):
                ...
                image_seed = gr.Textbox(label='Seed', value=0, max_lines=1, visible=False) # workaround for https://mirror.ghproxy.com/https://github.com/gradio-app/gradio/issues/5354
            ...
            with gr.Tab(label='Advanced'):
                ...
                gr.HTML('<a href="https://mirror.ghproxy.com/https://github.com/lllyasviel/Fooocus/discussions/117" target="_blank">\U0001F4D4 Document</a>')
